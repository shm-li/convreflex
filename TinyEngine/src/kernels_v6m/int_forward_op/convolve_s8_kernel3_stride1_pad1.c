...
tinyengine_status convolve_s8_kernel3_stride1_pad1(
	...
	int8_t* bytes = (int8_t*)&pad_out_q15x2;
		...
		if (base_idx_y == -1) { //pad the first row
			...
			for (int i_out_x = 0; i_out_x < output_x; i_out_x++) {
				...
				if (base_idx_x == -1){
					...
					int32_t *dst_32 = (int32_t*) &input_16b_buffer[input_ch * 3];
					int32_t *dst2_32 = (int32_t*) &input_16b_buffer[input_ch * 6];
					int block_cnt = channel_div4;
					while (block_cnt > 0) {
						*dst_32++ = pad_out_q15x2; *dst_32++ = pad_out_q15x2;
					...
					int16_t *dst = (int16_t*)dst_32;
					int16_t *dst2 = (int16_t*)dst2_32;
			...
			for (int i_out_x = 0; i_out_x < output_x; i_out_x++) {
				...
				if (base_idx_x == -1) {
					/* use pad for the first 1 col*/
					int32_t *dst_32 = (int32_t*) &input_16b_buffer[0];
					int32_t *dst2_32 = (int32_t*) &input_16b_buffer[input_ch * 3];
			...
			for (int i_out_x = 0; i_out_x < output_x; i_out_x++) {
				...
				if (base_idx_x == -1) {
					...
					int32_t *dst_32 = (int32_t*) &input_16b_buffer[0];
					int32_t *dst2_32 = (int32_t*) &input_16b_buffer[input_ch * 3];
					int32_t *dst3_32 = (int32_t*) &input_16b_buffer[input_ch * 6];
					int block_cnt = channel_div4;
					while (block_cnt > 0) {
						*dst_32++ = pad_out_q15x2; *dst_32++ = pad_out_q15x2;
						*dst2_32++ = pad_out_q15x2; *dst2_32++ = pad_out_q15x2;
